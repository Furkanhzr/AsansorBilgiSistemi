                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-5 d-none d-md-block">
                            <img src="{{asset('images')}}/onlinetran2.jpg"
                                 alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; object-fit: cover; width: 500px; height: 600px;" />
                        </div>
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-dark btn-lg btn-block" style="background-color: #f28123;" type="button">Giriş Yap</button>
                                    </div>

                                    <a class="small text-muted" href="#!">Şifremi unuttum</a>
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Zaten hesabın var mı? <a href="#!"
                                                                                                              style="color: #393f81;">Üye ol</a></p>
